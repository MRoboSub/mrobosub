...
class ThrusterController(Node):
    def __init__(self):
        ...
        rospy.Subscriber('/motor_pwm/1', Float64, self.motor_0_callback)
        rospy.Subscriber('/motor_pwm/2', Float64, self.motor_0_callback)
        rospy.Subscriber('/motor_pwm/3', Float64, self.motor_0_callback)
        rospy.Subscriber('/motor_pwm/4', Float64, self.motor_0_callback)
        rospy.Subscriber('/motor_pwm/5', Float64, self.motor_0_callback)
        rospy.Subscriber('/motor_pwm/6', Float64, self.motor_0_callback)
        rospy.Subscriber('/motor_pwm/7', Float64, self.motor_0_callback)
    
    # pwm_raw ranges from -1 to 1
    # pwm_val ranges from 4000 to 8000
    def convert_pwm_signal(self, pwm_raw: Float64):
    ...
    def send_signal(self, motor: int, pwm_raw: Float64):
        ...
        LSBs = pwm_val % (2**7) # TODO convert to uint8?
        MSBs = int(pwm_val/(2**7)) #TODO convert to uint8?
