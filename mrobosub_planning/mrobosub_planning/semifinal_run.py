from mrobosub_planning.common_states import  Start, Submerge, Surface, Stop, ComeUp, ReturnHome, Turn180_2, TimeoutFor30
...
from mrobosub_planning.semifinal_states import FindPathmarker, NavigateSlalom, TurnToGate, AlignGate, SemiAlignPathmarker, SemiCenterOnPathmarker, GoToOctagon
...
transitions: TransitionMap = {
    ...
    Forward5Seconds2.Reached: FindPathmarker,
    Forward5Seconds2.Unreached: FindPathmarker,
