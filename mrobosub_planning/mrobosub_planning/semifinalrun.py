from mrobosub_planning.common_states import Forward10, Start, Submerge, Surface, Stop, ComeUp, Turn180_2, TimeoutFor30, RevertCoinFlip, SlalomStraight, Turn90, GoOctagon, TurnOctagon
...
transitions: TransitionMap = {
    ...
    SlalomStraight.ReachedGate: TurnOctagon,
    SlalomStraight.TimedOut: TurnOctagon,

    TurnOctagon.Turned: GoOctagon,
    TurnOctagon.TimedOut: GoOctagon,

    GoOctagon.Finished: ComeUp,
    GoOctagon.TimedOut: ComeUp,
