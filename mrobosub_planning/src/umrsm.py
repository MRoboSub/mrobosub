...
class StateMeta(type):
    ...
    def __new__(cls, name: str, bases: tuple, dict_: dict) -> "StateMeta":
        ...
        for name in inherited:
            ...
            outcomes[name] = suboutcome
            setattr(state, name, suboutcome)
...
class State(metaclass=StateMeta):
    ...
    def is_valid_income_type(cls, outcome_type: Type[Outcome]) -> bool:
        """
        Used to ensure the validity of transition maps

        Some states require incoming transitions to contain data
        """
        return True
