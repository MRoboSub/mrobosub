...
- `mrobosub_localization` - The localization package. Attempts to estimate where the submarine is relative to its enviornment.
...
```
cd existing_repo
git remote add origin https://gitlab.eecs.umich.edu/mrobosub/mrobosub.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.eecs.umich.edu/mrobosub/mrobosub/-/settings/integrations)
