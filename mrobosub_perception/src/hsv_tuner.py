...
class HsvTuner(Node):
    ...
    def __init__(self):
        ...
        self.img_sub = rospy.Subscriber(
            "bot_cam", Image, self.handle_frame, queue_size=1
        )
    ...
    def handle_frame(self, msg):
        ...
        self.blur_pub.publish(
            self.br.cv2_to_imgmsg(self.pipeline.blur_output, encoding="bgr8")
        )
        ...
        for line in self.pipeline.filter_lines_output:
            image_final = cv2.line(
                image_final, (line.x1, line.y1), (line.x2, line.y2), (255, 0, 0), 3
            )
