...
class AprilTagDetector:
    def __init__(self):
        ...
        self.tag_size = 54  # in millimeter #TODO: Measure TAG SIZE
        ...
        if detections:
            for detect in detections:
                ...
                if detect['id'] >= 10:  # small tag at center
                    image_points = np.array(detect['lb-rb-rt-lt'], dtype=np.float32)
                    retval, rvec, tvec = cv2.solvePnP(self.small_object_points, image_points, flags=cv2.SOLVEPNP_IPPE_SQUARE)
