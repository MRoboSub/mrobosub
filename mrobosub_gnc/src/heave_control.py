...
class HeaveControlNode(Node):
    ...
    def __init__(self):
        ...
        self.twist_pid = PIDInterface("twist_heave_pid", self.twist_pid_callback)
        ...
        rospy.Subscriber('/target_twist/heave', Float64, self.target_twist_callback)
    ...
    def twist_pid_callback(self, effort: float):
        output= effort + self.feed_forward
        self.output_twist_heave(output)
