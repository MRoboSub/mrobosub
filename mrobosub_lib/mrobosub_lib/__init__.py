...
class Node(RosNode):
    ...
    # by returning success, we accept this parameter change (but also take this opportunity to update our self.param member variables)
    ...
    def declare_params(self, param_list: List[Param]):
        ...
        self.add_on_set_parameters_callback(self.set_params_callback)
